...
import com.btitsolutions.alphabetquiz.R;
...
public class RateThisApp {
    private final static String APP_TITLE = "Alphabet Quiz";// App Name
    private final static String APP_PNAME = "com.btitsolutions.alphabetquiz";// Package Name
